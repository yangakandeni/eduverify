"""Run from the repo root: python -m pytest scripts/tests/ -v
(seed_dynamodb.py inserts parser/ onto sys.path itself, relative to its own file location,
so this works regardless of cwd — see parser/CLAUDE.md for the equivalent parser/tests/ note.)
"""

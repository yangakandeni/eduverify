...
Usage:
    ...
    python scripts/seed_dynamodb.py --skip-public   # private institutions only
"""
...
DEFAULT_PUBLIC_UNIVERSITIES_PATH = BASE_DIR / "web" / "lib" / "data" / "public_universities.json"
DEFAULT_PUBLIC_TVETS_PATH = BASE_DIR / "web" / "lib" / "data" / "public_tvets.json"
...
def main():
    ...
    parser.add_argument("--public-universities-path", type=Path, default=DEFAULT_PUBLIC_UNIVERSITIES_PATH)
    parser.add_argument("--public-tvets-path", type=Path, default=DEFAULT_PUBLIC_TVETS_PATH)
